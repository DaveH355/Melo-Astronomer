...
public class Entity {
    ...
    @Getter private Array<Class<? extends EntitySystem>> optInSystems;
	...
	public Entity () {
        ...
        optInSystems = new Array<>(false, 16);
	}

    public void optIn(EntitySystem... systems) {
        for (EntitySystem system : systems) {
            optInSystems.add(system.getClass());
        }
    }
