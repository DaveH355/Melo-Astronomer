...
public class Family {
    ...
    @Getter private boolean optInOnly = false;
    @Getter @Setter private Class<? extends EntitySystem> systemType;
	...
	public static class Builder {
        ...
        private boolean optInOnly = false;
        ...
        public final Builder optInOnly() {
            this.optInOnly = true;
            return this;
        }
